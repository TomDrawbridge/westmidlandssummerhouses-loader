  ...
  return (
    <Html>
      <Head>
        ...
        <link rel="dns-prefetch" href="//cms.westmidlandssummerhouses.com" />
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `
              :root{--max-width:1100px;--border-radius:12px}
              *{box-sizing:border-box;padding:0;margin:0}
              html,body{max-width:100vw;font-family:system-ui,-apple-system,sans-serif}
